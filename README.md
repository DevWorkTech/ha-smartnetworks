...
- Предупреждает об окончании оплаченного тарифа за 5 дней, 3 дня и за день до окончания
- Отправляет предупреждения во все зарегистрированные `notify.mobile_app_*` устройства и одновременно показывает их в панели уведомлений Home Assistant
